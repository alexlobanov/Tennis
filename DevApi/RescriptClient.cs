...
{
    public class RescriptClient : HttpWebClientProtocol
    {
        ...
        {
            List<AccountKeys> key = null;
            return key;
            // return Invoke<AccountKeys>(ACCOUNTS_KEY_GET);
        }
        public AccountKeys getAccountKeys(string appName)
        {
            var args = new Dictionary<string, object>();
            AccountKeys key = null;
            return key;
        ...
        {
            var args = new Dictionary<string, object>();
            return Invoke<AccountInfo>(LIST_EVENT_TYPES_METHOD);
        }
