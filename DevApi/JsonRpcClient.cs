...
namespace Api_ng_sample_code
{
    public class JsonRpcClient  : HttpWebClientProtocol, IClient
    {
        ...
        private static readonly string ACCOUNTS_INFORMATION = "AccountAPING/v1.0/getAccountFunds";
        private static readonly string ACCOUNTS_KEY_CREATE = "AccountAPING/v1.0/createDeveloperAppKeys";
        private static readonly string ACCOUNTS_KEY_GET = "AccountAPING/v1.0/getDeveloperAppKeys";
        ...
        public List<TimeRangeResult> listTimeRanges(MarketFilter filter, string granularity)
        {
          ...
          bool netOfCommission)
        {
            ...
            return Invoke<List<MarketProfitAndLoss>>(LIST_MARKET_PROFIT_AND_LOSS, args);
        }
        public List<AccountKeys> getMyDevelopsApp()
        {
            return Invoke<List<AccountKeys>>(ACCOUNTS_KEY_GET);
        }

        public AccountKeys getAccountKeys(string appName)
        {
            var args = new Dictionary<string, object>();
            args[APPNAME] = appName;
            return Invoke<AccountKeys>(ACCOUNTS_KEY_CREATE, args);
        }
        public AccountInfo listAccountInfo()
        {
            var args = new Dictionary<string, object>();
            args[WALLET] = "UK";
            return Invoke<AccountInfo>(ACCOUNTS_INFORMATION,args);
        }
        ...
        public ClearedOrderSummaryReport listClearedOrders(BetStatus betStatus, ISet<string> eventTypeIds = null, ISet<string> eventIds = null, ISet<string> marketIds = null, ISet<RunnerId> runnerIds = null, ISet<string> betIds = null, Side? side = null, TimeRange settledDateRange = null, GroupBy? groupBy = null, bool? includeItemDescription = null, String locale = null, int? fromRecord = null, int? recordCount = null)
        {
            ...
            catch (APINGException)
            {
                Debug.WriteLine("ListClearedOrders");
                return null;
            }
        }
